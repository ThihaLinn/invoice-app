...
public class InvoiceController {
	...
	public ResponseEntity<String> createInvoice(@RequestBody InvoiceCreateRequest invoiceCreateRequest){
		invoiceService.createInvoice(
				 new InvoiceDto(invoiceCreateRequest.casherNumber(),invoiceCreateRequest.date(),invoiceCreateRequest.township(),invoiceCreateRequest.remark()),
	...
	public ResponseEntity<String> updateInvoice(@RequestBody InvoiceUpdateRequest invoiceUpdateRequest){
		var result = invoiceService.updateInvoice(
				...
				new InvoiceDto(invoiceUpdateRequest.casherNumber(),invoiceUpdateRequest.date(),invoiceUpdateRequest.township(),invoiceUpdateRequest.remark()),
